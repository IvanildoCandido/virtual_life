<div class="box feed-item" data-id="<?= $data->getId() ?>">
    <div class="box-body">
        <div class="feed-item-head row mt-20 m-width-20">
            ...
            <div class="feed-item-head-info">
                ...
                <span class="fidi-action">
                    ...
                    ?></span>
                <br />
                <span class="fidi-date"><?= date('d/m/Y', strtotime($data->getCreated_at())); ?></span>
            </div>
        ...
        <div class="feed-item-buttons row mt-20 m-width-20">
            <div class="like-btn <?= ($data->getLiked()) ? 'on' : ''; ?>"><?= $data->getLikesCount(); ?></div>
            <div class="msg-btn"><?= count($data->getComments()); ?></div>
        </div>
